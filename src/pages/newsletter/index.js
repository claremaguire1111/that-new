...
const NewsletterPage = () => {
  return (
    <SharedLayout activePath="/newsletter">
      <Section>
        <Container>
          <h1 style={{ 
            fontSize: '3.75rem', 
          ...
          <p style={{ 
            ...
            Regular updates, insights, community resources, and more from the Thinking About Thinking team
          </p>
          <ComingSoonContainer>
            <ComingSoonTitle>Join Our Community</ComingSoonTitle>
            <ComingSoonText>
              Subscribe to our newsletter to receive regular updates on AI research, upcoming events, community resources, and exclusive content. Join our growing community of AI researchers, practitioners, and enthusiasts to stay informed and connected.
            </ComingSoonText>
            
            <ButtonGroup>
              <Button as="a" href="https://lu.ma/home" target="_blank" rel="noopener noreferrer" primary>
                View Event Calendar
              </Button>
          ...
          <FeaturedTopicsContainer>
            <h3 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>What You'll Receive</h3>
            
            <TopicsList>
              <li>Event Announcements & Invitations</li>
              <li>THAT Summit Updates</li>
